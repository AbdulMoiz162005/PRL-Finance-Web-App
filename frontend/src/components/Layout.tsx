...
import {
  ...
  LogOut, Scale, Gauge, Sun, Moon, ShieldCheck,
} from 'lucide-react';
...
const NAV: NavItem[] = [
  ...
  { to: '/control-centre', label: 'Control Centre', icon: <ShieldCheck className="h-4 w-4" />, roles: ['admin', 'director', 'accountant', 'auditor', 'manager'] },
